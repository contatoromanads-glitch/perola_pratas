...
const IMAGES: GalleryImage[] = [
  {
    src: '/gallery-1.png',
    alt: 'Ponto de Luz Cravejado em prata 925',
    label: 'Colares',
    title: 'Ponto de Luz Cravejado',
  ...
  {
    src: '/gallery-3.png',
    alt: 'Colar Flor de Lótus em prata 925',
    label: 'Colares',
    title: 'Colar Flor de Lótus',
    sub: 'Confira disponibilidade com a nossa equipe.',
    className: 'aspect-[4/5]',
    delay: 2,
  },
