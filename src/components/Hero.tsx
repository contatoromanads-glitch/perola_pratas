    ...
    >
      ...
      >
        <defs>
          ...
          <linearGradient id={silhouetteGradId} x1="0" y1="0" x2="1" y2="1">
          ...
          <linearGradient id={silverGradId} x1="0" y1="0" x2="1" y2="0">
          ...
          <radialGradient id={pendantGlowId}>
          ...
          <symbol id={sparkleId} viewBox="-10 -10 20 20">
            <path
