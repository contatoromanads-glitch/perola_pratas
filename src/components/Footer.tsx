export default function Footer() {
  return (
    ...
    <footer className="bg-surface-0 border-t border-border-strong pt-20 px-6 md:px-10 pb-12 text-center relative z-10">
      <div className="reveal visible max-w-[560px] mx-auto flex flex-col items-center">
        <img src="/logo.png" alt="Pérola Pratas" className="logo-img h-11 mb-8 transition-transform duration-700 hover:scale-105" />

        <div className="flex items-center gap-6 my-10 w-full">
          <div className="fine-line flex-1 h-px bg-border-strong" aria-hidden="true" />
